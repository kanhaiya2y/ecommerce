...
const page = async ({ params }) => {
  ...
  async function getData() {
    // const res = await fetch(`https://fakestoreapi.com/products/${dynamic}`);
    // return res.json();
    const docRef = doc(db, "product", slug);
...
<div class="bg-gray-100 dark:bg-gray-800 py-8">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row -mx-4">
            ...
            <div class="md:flex-1 px-4">
                <h2 class="text-2xl font-bold text-gray-800 dark:text-white mb-2">{data.product}</h2>
                <p class="text-gray-600 dark:text-gray-300 text-sm mb-4">
                  
                </p>
                <div class="flex mb-4">
                    <div class="mr-4">
                        <span class="font-bold text-gray-700 dark:text-gray-300">{data.price}</span>
                        <span class="text-gray-600 dark:text-gray-300"></span>
                    </div>
                    <div>
                        <span class="font-bold text-gray-700 dark:text-gray-300">{data.brand}</span>
                ...
                <div>
                    <span class="font-bold text-gray-700 dark:text-gray-300">{data.description}</span>
